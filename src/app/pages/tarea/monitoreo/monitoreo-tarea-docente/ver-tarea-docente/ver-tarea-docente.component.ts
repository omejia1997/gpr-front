...
@Component({
  selector: 'app-ver-tarea-docente',
  templateUrl: './ver-tarea-docente.component.html',
  styleUrls: ['./ver-tarea-docente.component.css']
})
export class VerTareaDocenteComponent implements OnInit {
