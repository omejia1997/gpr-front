...
export class CrearTareaProgramadaVinculacionComponent implements OnInit {
  ...
  constructor(
    ...
    this.comboOpcionPeriodo = ["Diaria", "Semanal", "Mensual","Bimestral","Trimestral","Cuatrimestral","Semestral","Anual"];
  }
  ...
  buscarDocentesPorCargo() {
    this.getDocentes$ = this.tareaServiceGpr.obtenerTodosDocentesPorCargo(this.cargo.codCargo);
